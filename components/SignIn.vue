...
<script>
import SignInStepOne from "./SignIn/SignInStepOne.vue"
import SignInStepTwo from "./SignIn/SignInStepTwo.vue"
import SignInStepThree from "./SignIn/SignInStepThree.vue"
export default {
    components: {
        SignInStepOne,
        SignInStepTwo,
